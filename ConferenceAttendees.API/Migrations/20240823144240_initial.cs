        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Atendees_Genders_GenderId",
                        column: x => x.GenderId,
                        principalTable: "Genders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Atendees_JobRoles_JobRoleId",
                        column: x => x.JobRoleId,
                        principalTable: "JobRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Atendees_ReferralSources_ReferralSourceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Atendees_GenderId",
                table: "Atendees",
                column: "GenderId");

            migrationBuilder.CreateIndex(
                name: "IX_Atendees_JobRoleId",
                table: "Atendees",
                column: "JobRoleId");

            migrationBuilder.CreateIndex(
                name: "IX_Atendees_ReferralSourceId",
                table: "Atendees",
